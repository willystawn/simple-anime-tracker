...
export const SparklesIcon: React.FC<{className?: string}> = ({ className = "h-5 w-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10 20l-2-6-6-2 6-2 2-6 2 6 6 2-6 2-2 6z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 10l-2-6-6-2 6-2 2-6 2 6 6 2-6 2-2 6z" />
    </svg>
);

export const SearchIcon: React.FC<{className?: string}> = ({ className = "h-5 w-5 text-light-gray" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
